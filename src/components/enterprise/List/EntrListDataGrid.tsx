...
import {DataGrid, GridColDef, GridRowModel, GridRowSelectionModel, useGridApiRef} from '@mui/x-data-grid';
import Box from "@mui/material/Box";
import {TEnterprise} from "./types";
...
const EntrListDataGrid: React.FC<DataGridProps> = ({rows, setSelectedRows}) => {
    return (
        <Box sx={{
            height: 370,
            width: '100%',
            ...
            <DataGrid
                ...
                localeText={{
                    ...
                    noRowsLabel: 'Предприятия не найдены',
                    MuiTablePagination: {
...
export default EntrListDataGrid;